      ...
      <header className="relative z-50 border-b border-cyan-400/30 bg-cyan-500/[0.06] backdrop-blur">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/comunidade"
              className="hidden sm:flex rounded-lg border border-cyan-400/50 px-4 py-2 text-base text-cyan-300 transition hover:bg-cyan-500/[0.12] hover:text-cyan-200"
            >
              Comunidade
            </Link>
            <Link
              ...
              {menuOpen && (
                <>
                  <div className="absolute right-0 top-full mt-1 z-50 w-44 rounded-xl border border-cyan-400/30 bg-[#0a0a0f] shadow-2xl">
                    <Link href="/comunidade" onClick={() => setMenuOpen(false)} className="block rounded-t-xl px-4 py-3 text-sm text-cyan-300 hover:bg-cyan-500/10">Comunidade</Link>
                    <Link href="/perfil" onClick={() => setMenuOpen(false)} className="block px-4 py-3 text-sm text-zinc-300 hover:bg-cyan-500/10">Perfil</Link>
