        ...
        <section className="mt-8 space-y-8">
          ...
          <div>
            ...
            {!topics ? (
              ...
              <p className="mt-3 rounded-2xl border border-violet-500/20 bg-violet-500/[0.03] backdrop-blur-sm p-6 text-lg text-zinc-400">
              ...
              <div className="mt-3 space-y-3">
                {topics.map((t) => (
                  <article
                    ...
                    className="cursor-pointer rounded-2xl border border-violet-500/20 bg-violet-500/[0.03] backdrop-blur-sm p-5 transition hover:border-amber-600/40 hover:bg-zinc-900/70"
                  >
