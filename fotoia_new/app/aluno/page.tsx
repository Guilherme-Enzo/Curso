    ...
    <section className="mt-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="shrink-0 ml-3 grid h-10 w-10 place-items-center rounded-xl border border-violet-400/25 text-zinc-400 transition hover:bg-zinc-800 hover:text-white"
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <div className="flex items-center gap-3">
                  <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-violet-500/20 to-cyan-500/20 text-xl font-black text-violet-300">
                    {mod.order}
                  </span>
                  <div>
                ...
                {mod.pdfUrl ? (
                  <>
                    <a
                      ...
                      className="rounded-xl bg-gradient-to-r from-violet-500 to-cyan-500 px-5 py-3 text-center text-base font-bold text-zinc-950 transition hover:-translate-y-0.5"
                    >
                      Visualizar
                    </a>
                    <a href={mod.pdfUrl}
                      download
                      className="rounded-xl border border-violet-400/25 px-5 py-3 text-center text-base font-semibold text-zinc-200 transition hover:bg-white/5"
                    >
                      Baixar
                    </a>
                  </>
...
/* Quiz and performance UI removed.
    ...
    return (
      <section className="mt-6 space-y-6">
        <button
          ...
          className="rounded-xl border border-violet-400/25 px-4 py-2 text-base font-semibold text-zinc-300 transition hover:bg-white/5"
        >
          ← Voltar
        </button>
                    ...
                    className={`flex w-full items-center gap-3 rounded-xl border px-4 py-4 text-left text-base transition ${
                      !result
                        ? chosen
                          ...
                          : "border-violet-400/25 bg-zinc-950 text-zinc-300 hover:border-amber-500/50 hover:text-white"
                        : isCorrect
                        ? "border-emerald-500 bg-emerald-500/10 text-white"
                        : isWrongPick
                        ? "border-red-500/70 bg-red-500/10 text-white"
                        : "border-violet-400/25 bg-zinc-950 text-zinc-500"
                    }`}
                  >
        ...
        {result ? (
          ...
          <>
            ...
            <button
              ...
              className="w-full rounded-xl bg-gradient-to-r from-violet-500 to-cyan-500 px-6 py-4 text-lg font-bold text-zinc-950 transition hover:-translate-y-0.5 disabled:opacity-40 sm:w-auto"
            >
          ...
          <div className="mt-4 grid gap-3">
            {quizzes.map((q, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="flex flex-wrap items-center gap-2 text-lg font-semibold text-white">
                      {q.title}
                      {q.source === "ia" && (
                        <span className="rounded-full border border-amber-500/40 bg-amber-500/10 px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-wider text-violet-300">
                          IA
                        </span>
                      )}
                    </p>
                ...
                <span className="shrink-0 rounded-xl border border-violet-400/25 px-4 py-2 text-base font-semibold text-violet-300">
                  Fazer →
                </span>
              </button>
            ))}
...
/* Removed performance UI and supporting quiz result code.
/*
type AttemptItem = {
  id: string;
  correct: number;
  ...
  return (
    <section className="mt-6 space-y-8">
      ...
      <p className="rounded-2xl border border-zinc-800 bg-zinc-900 p-5 text-base leading-relaxed text-zinc-400">
        ...
        <span className="font-semibold text-violet-300">Conteúdo</span> (com um módulo
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-3 border-b border-violet-400/30 bg-zinc-950/50 px-5 py-4">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <span className="rounded-full border border-violet-400/25 px-3 py-1 text-zinc-300">
                      {g.items.length}{" "}
